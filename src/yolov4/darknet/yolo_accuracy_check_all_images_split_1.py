...
OUTPUT_PATH = os.path.join(predictor_path, 'output_3005_all_images_split_1')
...
yolo_wghts = os.path.join(yolov4_path, 'BACKUP_BATCHES_WINTER_2024\yolo_training_4_split_1_0205', 'yolov4-custom_best.weights')
...
with open( os.path.join(predictor_path,'yolo_accuracy_check_3005_split_1_all_images.csv'), 'w', newline='') as file:
