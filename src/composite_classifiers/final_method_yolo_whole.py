...
csv_path = "./final_method_results/final_method_yolo_whole_prediction_split_1.csv"
image_directory_path = r"D:\Users Data\arthurSoussan\Desktop\detr\final_sets\test_split_1" # images folder - can be changed by user
INPUT_TEST_LIST = os.path.join(r"D:\Users Data\arthurSoussan\Desktop\Cannabis_project_2024\dataset_and_splits\splits\lists\split_1\without_spaces", 'test_split_1.txt')
...
def yolo_predict(weights_folder, threshold):
    ...
    with open(INPUT_TEST_LIST, 'r') as file:
        for im in file:
            ...
            csv_image_result = yolo_decision_strategy(yolo_result_file_path, image_path, image_name)
            csv_output.append(csv_image_result)
    return csv_output


def yolo_decision_strategy (yolo_result_file_path, image_path, image_name): #return array with results ready for csv\
...
csv_output = yolo_predict(YOLO_WEIGHTS_FOLDER, 0.05)
